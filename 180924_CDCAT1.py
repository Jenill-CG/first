...
def create_attendance_pdf(pdf, column_widths, column_names, info_values, df, format_option):
    ...
    pdf.cell(info_cell_width*0.53, 6,"        All details should be filled by the test administrator in ", border=0, ln=0)
    pdf.cell(info_cell_width*0.25, 6,"English  BLOCK LETTERS", border=0, ln=0,align="L")
