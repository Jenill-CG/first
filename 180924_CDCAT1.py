...
def create_attendance_pdf(pdf, column_widths, column_names, info_values, df, format_option):
    ...
    pdf.cell(info_cell_width*0.55, 6,"        All details should be filled by the test administrator in ", border=0, ln=0)
    pdf.cell(info_cell_width*0.23, 6,"English  BLOCK LETTERS", border=0, ln=0,align="L")
    pdf.cell(info_cell_width*0.22, 6,"only", border=0, ln=1, align="L")
