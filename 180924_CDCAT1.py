...
def create_attendance_pdf(pdf, column_widths, column_names, info_values, df, format_option):
    ...
    # Centered Title
    pdf.cell(merged_cell_width, 4, 'STUDENTS ATTENDANCE SHEET', border=0, align='C', ln=2)
    ...
    pdf.cell(info_cell_width, 3, f"STATE : {info_labels['STATE']}", border=0, ln=1)
    pdf.cell(info_cell_width, 3, f"DISTRICT : {info_labels['DISTRICT']}", border=0, ln=1)
    
    # Add the SCHOOL NAME
    # pdf.cell(school_name_width, 3, f"SCHOOL : {info_labels['SCHOOL']}",border=0, ln=0)  # Left border only
    pdf.cell(info_cell_width, 3, f"SCHOOL : {info_labels['SCHOOL']}", border=0, ln=0)  # Left border only
    ...
    pdf.cell(info_cell_width, 3, f"UDISE CODE : {info_labels['UDISE CODE']}", border=0, ln=1)
    pdf.cell(info_cell_width, 3, f"CLASS : {info_labels['CLASS']}", border=0, ln=1)
