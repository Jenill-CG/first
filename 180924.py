...
def main():
    ...
    st.markdown("<div class='custom-header' style="background-color: #ffffff; padding: 15px; border-radius: 10px; box-shadow: 0px 4px 8px rgba(0, 0, 0, 0.2);">CGI's ID Generator Tool</div>", unsafe_allow_html=True)
