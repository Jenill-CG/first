...
def main():
    ...
    st.markdown("<div class='custom-header' style='font-size: 26px;color: #F0BF4C;text-align: right;padding: 2px; background-color: #ffffff; margin-top: 2px;margin-bottom: 2px;'>Generate unique IDs quickly and easily!</div>", unsafe_allow_html=True)
