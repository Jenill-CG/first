...
def main():
    ...
    st.markdown("<div class='custom-header' style='font-size: 26px;color: #F0BF4C;text-align: right;padding: 2px; background-color: #ffffff; margin-top: 2px;margin-bottom: 2px;box-shadow: 0px 4px 8px rgba(0, 0, 0, 0);text-shadow: 1px 1px 2px rgba(0, 0, 0, 0);'>JAVP</div>", unsafe_allow_html=True)
